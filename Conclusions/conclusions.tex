...
\begin{itemize}
    \item \textbf{Contextual Challenges:} SMEs in developing regions face persistent barriers to cloud adoption, including limited expertise, inadequate infrastructure, and unclear regulatory enforcement \citep{Kumar2017Exploring}.
...
\begin{enumerate}
    ...
    \item Integration of \textbf{international best practices} (NIST, ISO/IEC, ENISA) with \textbf{regionally relevant controls}, ensuring compatibility with local regulations such as Lebanon’s Law No.~81 (2018).
