...
\begin{itemize}
    \item \textbf{Contextual Challenges:} SMEs in developing regions face persistent barriers to cloud adoption, including limited expertise, inadequate infrastructure, and unclear regulatory enforcement \citep{Skafi2020Factors}.
