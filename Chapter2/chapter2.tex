...
\begin{table}[htbp]
    ...
    \begin{tabular}{|l|c|c|c|c|c|l|}
        ...
        \hline
        MFA Framework & Partial & \ding{51} & \ding{51} & \ding{51} & \ding{51} & Limited pilot \\
        \hline
...
In contrast, practical platforms such as CloudRecoMan and CMDSS provide partial deployment guidance by translating business requirements into recommended cloud configurations or migration paths. Infrastructure-as-Code tools further strengthen deployment guidance by enabling reproducible and policy-driven provisioning; however, these tools are rarely integrated into a broader SME-oriented framework.
...
CloudRecoMan and lightweight MFA frameworks demonstrate greater cost sensitivity by design, whereas decision-support systems and assessment tools acknowledge cost benefits without offering concrete optimization mechanisms. Enterprise-oriented security standards largely ignore cost considerations, reinforcing the cost--security trade-off faced by SMEs.
...
Only a small number of studies report pilot implementations or quantified outcomes, such as the documented reduction in security incidents achieved through monitoring solutions or usability evaluations of decision-support platforms. Longitudinal evaluations and cost--security performance measurements remain largely absent.

\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{"c:/Users/samaw/OneDrive - Arab Open University - AOU/Final Project/Ahmad_samawi_231116/Figures/SME cloud adoption research framework diagram".png}
