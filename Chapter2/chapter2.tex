...
Cloud computing has been widely promoted as a catalyst for digital transformation among small and medium-sized enterprises (SMEs), offering scalable resources, reduced capital expenditure, and access to advanced information systems previously available only to large organizations \cite{Misra2022Factors, Yuwono2024Information}. In developing regions, these promised benefits are often framed as particularly transformative, with cloud adoption positioned as a mechanism to overcome infrastructural and economic limitations. However, empirical evidence suggests that the adoption and secure use of cloud services by SMEs in such contexts remains uneven, constrained, and risk-laden.
...
Empirical studies consistently identify cost efficiency, scalability, flexibility, and ease of deployment as primary motivators for SME cloud adoption. Subscription-based pricing models reduce capital expenditure, while on-demand resource provisioning allows SMEs to align IT consumption with fluctuating business needs. For resource-constrained firms, these characteristics are frequently cited as enablers of operational agility and market responsiveness.
...
Reported levels of security concern vary substantially across regions, ranging from 14.3\% among Jordanian SMEs to 56\% among Lebanese SMEs \cite{Al2018Factors, Skafi2020Factors}. This variation cannot be attributed solely to differences in technical sophistication. Instead, it reflects divergent risk perceptions shaped by environmental uncertainty and recovery capacity. SMEs operating in politically or economically unstable contexts demonstrate heightened sensitivity to security risks, as they possess limited financial and operational buffers to absorb the consequences of breaches. In contrast, SMEs with established online operations and prior exposure to digital systems exhibit greater tolerance for security risk, even when objective threats remain present. This indicates that security concern is fundamentally contextual and perception-driven, reinforcing the need for frameworks that adapt risk controls to local realities rather than assuming uniform threat prioritization.

\subsection{Infrastructure Versus Expertise as Sequential Constraints}

The literature reveals a systematic shift in dominant barriers as cloud markets mature. In early-stage adoption contexts, such as Lebanon and Turkey, inadequate IT infrastructure and unreliable connectivity represent the primary constraints \cite{Skafi2020Factors, Sayginer2021Multi}. As baseline infrastructure improves, expertise-related barriers become more salient, as observed in more mature markets such as India \cite{Narwane2020Mediating}. This progression suggests a sequencing effect in which infrastructure limitations must be addressed before skills shortages become the binding constraint. Existing frameworks, however, rarely account for this temporal and developmental ordering, instead treating all barriers as simultaneously active. This limits their practical applicability for SMEs at different stages of digital maturity.

\subsection{Framework Effectiveness and Theoretical Limitations}

The widespread adoption of TOE-based models reflects their flexibility rather than their explanatory completeness. Extensions that incorporate contextual or social factors demonstrate improved explanatory power, yet substantial variance in adoption behavior remains unexplained \cite{Sayginer2021Multi}. Empirical findings showing limited predictive strength of perceived benefits challenge the assumption that cloud adoption follows rational, benefit-driven decision-making. Instead, adoption emerges as a risk-management decision constrained by organizational capacity and environmental uncertainty. Current theoretical models remain effective for explaining adoption intention but provide limited guidance for secure deployment, operational sustainability, or post-adoption risk management \cite{Owusu2020Determinants}.
...
These limitations establish a clear research gap and justify the need for a Secure Cloud Deployment Framework (SCDF) tailored to the capabilities and risk environments of SMEs in developing regions. The next chapter presents the research methodology adopted to design and validate the proposed framework.
